---
title: 'How to apply dynamic gradient to a card'
date: 2022-02-07T15:32:14Z
lastmod: '2022-02-20'
tags: ['next-js', 'tailwind']
draft: true
summary: 'A simple code snippet that can be used to apply dynamic gradient to a  card.'
layout: PostSimple
bibliography: references-data.bib
heroimage: /static/images/ocean.jpeg
